...
QGIS.WMSServiceInfoPanel = Ext.extend(Ext.Panel, {
    ...
    loadServiceInfo: function() {
        ...
        if ((person + organization + phone + email).trim().length > 0){
            html += '<p class="sogisHinweisTitle">' + 'Kontakt (fachlich):' + '</p>';
        }
        ...
        html += '<p class="sogisHinweisText">Aus der Darstellung können keine rechtlichen Ansprüche abgeleitet werden.';
        html += '<br />Für Fragen, Lob oder Verbesserungsvorschläge senden Sie bitte ein Mail an: ';
        html += '<a href="mailto:michael.pfeiffer@bd.so.ch">michael.pfeiffer@bd.so.ch</a></p>';
        html += '</div>';
